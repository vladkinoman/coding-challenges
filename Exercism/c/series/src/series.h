...
// slices - routine to slice up input text into consecutive substrings of text of a given substring_length
//
// inputs:
//    input_text - bounded to MAX_INPUT_TEXT_LENGTH
//    substring_length - the desired length of substrings that are returned bounded to MAX_SERIES_LENGTH
//
// outputs:
//    slices_t results - structure containing count of the substrings and an array of
